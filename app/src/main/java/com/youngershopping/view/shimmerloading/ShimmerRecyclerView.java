...
package com.youngershopping.view.shimmerloading;
...
public class ShimmerRecyclerView extends RecyclerView {
    ...
    private static final String TAG = ShimmerRecyclerView.class.getName();
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            setDemoLayoutReference(a.getResourceId(R.styleable.ShimmerRecyclerView_shimmer_demo_layout, R.layout.shimmer_sample_view));
    ...
    public void setDemoLayoutManager(LayoutMangerType type) {
        ...
        Log.e(TAG, "setDemoLayoutManager: "+mLayoutMangerType );
    }
