...
package com.youngershopping.view.rangbar;
...
class PinView extends View {
    ...
    /**
     * The view is created rating_empty with a default constructor. Use init to set all the initial
    ...
    public void init(Context ctx, float y, float pinRadiusDP, int pinColor, int textColor,
        ...
        mPin = ContextCompat.getDrawable(ctx, R.drawable.rangebar_rotate);
